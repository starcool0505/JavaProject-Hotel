...
<head>
   ...
   String[] activityId = ActivityDaoImpl.getActivityId();
   String[] activityImgPath = ActivityDaoImpl.getActivityImgPaths();
   String[] activityName = ActivityDaoImpl.getActivityNames();
   String[] activityDate = ActivityDaoImpl.getActivityDates();
   String[] activityDescriptions = ActivityDaoImpl.getActivityDescriptions();
