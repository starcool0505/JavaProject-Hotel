...
<html>
	<head>
		...
		<style>
			...
			.credit-card-container label, .credit-card-container input
			{
				display: block;
				margin-bottom: 15px;
			}
		...
		<script>
			function showConfirmation()
			{
				...
				if (isConfirmed) {
					...
					var redirectURL = 'page6.jsp' + '?name='
							+ encodeURIComponent(name) + '&phone='
							+ encodeURIComponent(phone) + '&email='
							+ encodeURIComponent(email) + '&special-requests='
							+ encodeURIComponent(specialRequests);
